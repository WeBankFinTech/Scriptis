...
export default {
    ...
    data() {
        return {
            leftSideNavList: [
                { key: 2, name: '工作空间', isActive: false, icon: 'fi-project' },
                { key: 3, name: '数据库', isActive: false, icon: 'fi-hivedb' },
                { key: 4, name: 'UDF函数', isActive: false, icon: 'fi-fx-udf' },
                { key: 5, name: '方法函数', isActive: false, icon: 'fi-fx-method' },
                { key: 6, name: 'HDFS', isActive: false, icon: 'fi-disk' },
            ],
            leftModule: null,
            level: 0,
            navHeight: 0,
